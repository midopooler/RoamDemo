...
namespace ThisOtherThing.UI
{
	public class GeoUtils
	{
		...
		public class RoundingProperties
		{
			...
			[Minimum(2)]public int FixedResolution = 10;
			[Minimum(0.01f)]public float ResolutionMaxDistance = 4.0f;
		...
		public class ShadowsProperties
		{
			...
			[Minimum(0.0f)] public float Distance = 0.0f;
		...
		public class ShadowProperties
		{
			...
			[Minimum(0.0f)] public float Size = 5.0f;
