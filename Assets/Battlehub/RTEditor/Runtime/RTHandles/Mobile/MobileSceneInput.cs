...
namespace Battlehub.RTHandles
{
    public class MobileSceneInput : RuntimeSelectionInputBase
    {
        ...
        {
            /* The following code does not work correctly in the WebGL build.
            ITouchInput input = SceneComponent.Editor.TouchInput;
            return input.GetTouch(0).deltaPosition;
            */

            Vector2 screenPoint = SceneComponent.Window.Pointer.ScreenPoint;
            return screenPoint - m_prevScreenPoint;
        }
        ...
        protected override void LateUpdate()
        {
            ...
            bool beginRotate = rotate != m_rotate && (m_rotate = rotate);
            bool orbit = OrbitAction();
            bool beginOrbit = orbit != m_orbit && (m_orbit = orbit);
